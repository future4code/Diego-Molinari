...
const ApplicationPage = () => {
  ...
  const onSubmitApplication = (event) => {
    ...
    axios.post(
      `https://us-central1-labenu-apis.cloudfunctions.net/labeX/diego-molinari-turing/trips/${form.trip.id}/apply`,
      body,
    );
  };
    ...
    <div>
      ...
      <FormContainer onSubmit={onSubmitApplication}>
        ...
        <TextField
          ...
          helperText="Explique porque você é um bom candidato"
          onChange={onChangeInput}
